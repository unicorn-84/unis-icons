...
import { ArrowBendDownLeft } from '../componets';

describe('ArrowBendDownLeft', () => {
  describe('props: size = xs', () => {
    test('should render correctly', async () => {
      render(<ArrowBendDownLeft data-testid="test" size="xs" />);
    ...
    test('should forward classes', () => {
      render(
        <ArrowBendDownLeft data-testid="test" className="class" size="xs" />
      );
    ...
    describe('props: stroke', () => {
      test('should render correctly', () => {
        render(<ArrowBendDownLeft data-testid="test" stroke="red" size="xs" />);
  ...
  describe('props: size = sm', () => {
    test('should render correctly', async () => {
      render(<ArrowBendDownLeft data-testid="test" size="sm" />);
    ...
    test('should forward classes', () => {
      render(
        <ArrowBendDownLeft data-testid="test" className="class" size="sm" />
      );
      expect(screen.getByTestId('test')).toHaveClass('class');
    });
    ...
    describe('props: stroke', () => {
      test('should render correctly', () => {
        render(<ArrowBendDownLeft data-testid="test" stroke="red" size="sm" />);
  ...
  describe('props: size = md', () => {
    test('should render correctly', async () => {
      render(<ArrowBendDownLeft data-testid="test" size="md" />);
    ...
    test('should forward classes', () => {
      render(
        <ArrowBendDownLeft data-testid="test" className="class" size="md" />
      );
      expect(screen.getByTestId('test')).toHaveClass('class');
    });
    ...
    describe('props: stroke', () => {
      test('should render correctly', () => {
        render(<ArrowBendDownLeft data-testid="test" stroke="red" size="md" />);
