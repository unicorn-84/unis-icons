...
describe('ArrowClockwise', () => {
  test('should render correctly', async () => {
    render(<UnisIcons.ArrowClockwise data-testid="test" />);
...
describe('ArrowDown', () => {
  test('should render correctly', async () => {
    render(<UnisIcons.ArrowDown data-testid="test" />);
...
describe('ArrowDownRight', () => {
  test('should render correctly', async () => {
    render(<UnisIcons.ArrowDownRight data-testid="test" />);

    expect(screen.getByTestId('test')).toBeVisible();
  });
});

describe('ArrowElbowDownLeft', () => {
  test('should render correctly', async () => {
    render(<UnisIcons.ArrowElbowDownLeft data-testid="test" />);

    expect(screen.getByTestId('test')).toBeVisible();
  });
});

describe('ArrowElbowDownRight', () => {
  test('should render correctly', async () => {
    render(<UnisIcons.ArrowElbowDownRight data-testid="test" />);

    expect(screen.getByTestId('test')).toBeVisible();
  });
});

describe('ArrowElbowLeft', () => {
  test('should render correctly', async () => {
    render(<UnisIcons.ArrowElbowLeft data-testid="test" />);

    expect(screen.getByTestId('test')).toBeVisible();
  });
});

describe('ArrowElbowLeftDown', () => {
  test('should render correctly', async () => {
    render(<UnisIcons.ArrowElbowLeftDown data-testid="test" />);

    expect(screen.getByTestId('test')).toBeVisible();
  });
});

describe('ArrowElbowLeftUp', () => {
  test('should render correctly', async () => {
    render(<UnisIcons.ArrowElbowLeftUp data-testid="test" />);
...
describe('ArrowElbowRightDown', () => {
  test('should render correctly', async () => {
    render(<UnisIcons.ArrowElbowRightDown data-testid="test" />);

    expect(screen.getByTestId('test')).toBeVisible();
  });
});

describe('ArrowElbowRightUp', () => {
  test('should render correctly', async () => {
    render(<UnisIcons.ArrowElbowRightUp data-testid="test" />);

    expect(screen.getByTestId('test')).toBeVisible();
  });
});

describe('ArrowElbowUpLeft', () => {
  test('should render correctly', async () => {
    render(<UnisIcons.ArrowElbowUpLeft data-testid="test" />);

    expect(screen.getByTestId('test')).toBeVisible();
  });
});

describe('ArrowElbowUpRight', () => {
  test('should render correctly', async () => {
    render(<UnisIcons.ArrowElbowUpRight data-testid="test" />);
...
describe('ArrowFatLeft', () => {
  test('should render correctly', async () => {
    render(<UnisIcons.ArrowFatLeft data-testid="test" />);

    expect(screen.getByTestId('test')).toBeVisible();
  });
});

describe('ArrowFatLineDown', () => {
  test('should render correctly', async () => {
    render(<UnisIcons.ArrowFatLineDown data-testid="test" />);
...
describe('ArrowFatLineRight', () => {
  test('should render correctly', async () => {
    render(<UnisIcons.ArrowFatLineRight data-testid="test" />);
