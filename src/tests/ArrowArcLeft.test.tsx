...
import { ArrowArcLeft } from '../componets';

describe('ArrowArcLeft', () => {
  describe('props: size = xs', () => {
    test('should render correctly', async () => {
      render(<ArrowArcLeft data-testid="test" size="xs" />);

      expect(screen.getByTestId('test')).toBeVisible();
    });

    test('should forward classes', () => {
      render(<ArrowArcLeft data-testid="test" className="class" size="xs" />);
    ...
    describe('props: stroke', () => {
      test('should render correctly', () => {
        render(<ArrowArcLeft data-testid="test" stroke="red" size="xs" />);
  ...
  describe('props: size = sm', () => {
    test('should render correctly', async () => {
      render(<ArrowArcLeft data-testid="test" size="sm" />);

      expect(screen.getByTestId('test')).toBeVisible();
    });

    test('should forward classes', () => {
      render(<ArrowArcLeft data-testid="test" className="class" size="sm" />);
      expect(screen.getByTestId('test')).toHaveClass('class');
    });
    ...
    describe('props: stroke', () => {
      test('should render correctly', () => {
        render(<ArrowArcLeft data-testid="test" stroke="red" size="sm" />);
  ...
  describe('props: size = md', () => {
    test('should render correctly', async () => {
      render(<ArrowArcLeft data-testid="test" size="md" />);

      expect(screen.getByTestId('test')).toBeVisible();
    });

    test('should forward classes', () => {
      render(<ArrowArcLeft data-testid="test" className="class" size="md" />);
      expect(screen.getByTestId('test')).toHaveClass('class');
    });
    ...
    describe('props: stroke', () => {
      test('should render correctly', () => {
        render(<ArrowArcLeft data-testid="test" stroke="red" size="md" />);
