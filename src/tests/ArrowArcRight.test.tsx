...
import { ArrowArcRight } from '../componets';

describe('ArrowArcRight', () => {
  describe('props: size = xs', () => {
    test('should render correctly', async () => {
      render(<ArrowArcRight data-testid="test" size="xs" />);

      expect(screen.getByTestId('test')).toBeVisible();
    });

    test('should forward classes', () => {
      render(<ArrowArcRight data-testid="test" className="class" size="xs" />);
    ...
    describe('props: stroke', () => {
      test('should render correctly', () => {
        render(<ArrowArcRight data-testid="test" stroke="red" size="xs" />);
  ...
  describe('props: size = sm', () => {
    test('should render correctly', async () => {
      render(<ArrowArcRight data-testid="test" size="sm" />);

      expect(screen.getByTestId('test')).toBeVisible();
    });

    test('should forward classes', () => {
      render(<ArrowArcRight data-testid="test" className="class" size="sm" />);
      expect(screen.getByTestId('test')).toHaveClass('class');
    });
    ...
    describe('props: stroke', () => {
      test('should render correctly', () => {
        render(<ArrowArcRight data-testid="test" stroke="red" size="sm" />);
  ...
  describe('props: size = md', () => {
    test('should render correctly', async () => {
      render(<ArrowArcRight data-testid="test" size="md" />);

      expect(screen.getByTestId('test')).toBeVisible();
    });

    test('should forward classes', () => {
      render(<ArrowArcRight data-testid="test" className="class" size="md" />);
      expect(screen.getByTestId('test')).toHaveClass('class');
    });
    ...
    describe('props: stroke', () => {
      test('should render correctly', () => {
        render(<ArrowArcRight data-testid="test" stroke="red" size="md" />);
