...
const MoMacao = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g filter="url(#mo-macao_svg__a)">
      <g clipPath="url(#mo-macao_svg__b)">
        <mask
          id="mo-macao_svg__c"
          width={36}
          height={24}
        ...
        <g mask="url(#mo-macao_svg__c)">
          ...
          <g mask="url(#mo-macao_svg__d)">
            ...
            <g mask="url(#mo-macao_svg__e)" fill="#F7FCFF">
              <path
                fillRule="evenodd"
