...
const AqAntarctica = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g filter="url(#aq-antarctica_svg__a)">
      <g clipPath="url(#aq-antarctica_svg__b)">
        <mask
          id="aq-antarctica_svg__c"
          width={36}
          height={24}
          x={3}
          y={2}
        ...
        <g mask="url(#aq-antarctica_svg__c)">
          <path
            fill="#5196ED"
            fillRule="evenodd"
            d="M3 2v24h36V2H3Z"
          ...
          <g mask="url(#aq-antarctica_svg__d)">
            <path
              fill="#F5F8FB"
              fillRule="evenodd"
    ...
    <defs>
      <clipPath id="aq-antarctica_svg__b">
        <rect width={36} height={24} x={3} y={2} fill="#fff" rx={2} />
      </clipPath>
      <filter
        id="aq-antarctica_svg__a"
        width={42}
        height={30}
        x={0}
        y={0}
