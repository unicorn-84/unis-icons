...
const MaMorocco = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g filter="url(#ma-morocco_svg__a)">
      <g clipPath="url(#ma-morocco_svg__b)">
        <mask
          id="ma-morocco_svg__c"
          width={36}
          height={24}
          x={3}
          y={2}
        ...
        <g mask="url(#ma-morocco_svg__c)" fillRule="evenodd" clipRule="evenodd">
          <path
            fill="#C51918"
    ...
    <defs>
      <clipPath id="ma-morocco_svg__b">
        <rect width={36} height={24} x={3} y={2} fill="#fff" rx={2} />
      </clipPath>
      <filter
        id="ma-morocco_svg__a"
        width={42}
        height={30}
        x={0}
        y={0}
