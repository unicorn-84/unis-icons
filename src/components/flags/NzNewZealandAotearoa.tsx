...
const NzNewZealandAotearoa = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g filter="url(#nz-new-zealand-aotearoa_svg__a)">
      <g clipPath="url(#nz-new-zealand-aotearoa_svg__b)">
        <mask
          id="nz-new-zealand-aotearoa_svg__c"
          width={36}
          height={24}
          x={3}
          y={2}
        ...
        <g mask="url(#nz-new-zealand-aotearoa_svg__c)">
          <path
            fill="#2E42A5"
            fillRule="evenodd"
            d="M3 2v24h36V2H3Z"
          ...
          />
          <mask
            id="nz-new-zealand-aotearoa_svg__d"
            width={36}
            height={24}
            x={3}
            y={2}
          ...
          <g mask="url(#nz-new-zealand-aotearoa_svg__d)">
            <path fill="#2B409A" d="M3 2h20.25v14H3z" />
            <mask
              id="nz-new-zealand-aotearoa_svg__e"
              width={21}
              height={14}
              x={3}
              y={2}
            ...
            <g mask="url(#nz-new-zealand-aotearoa_svg__e)">
              <path
                fill="#F7FCFF"
              ...
              />
              <mask
                id="nz-new-zealand-aotearoa_svg__f"
                width={24}
                height={18}
                x={1}
                y={0}
              ...
              <path
                ...
                mask="url(#nz-new-zealand-aotearoa_svg__f)"
              />
            </g>
            <path
              fill="#F50100"
    ...
    <defs>
      <clipPath id="nz-new-zealand-aotearoa_svg__b">
        <rect width={36} height={24} x={3} y={2} fill="#fff" rx={2} />
      </clipPath>
      <filter
        id="nz-new-zealand-aotearoa_svg__a"
        width={42}
        height={30}
        x={0}
        y={0}
...
export default NzNewZealandAotearoa;
