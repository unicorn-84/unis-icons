...
const FmFederatedStatesOfMicronesia = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g filter="url(#fm-federated-states-of-micronesia_svg__a)">
      <g clipPath="url(#fm-federated-states-of-micronesia_svg__b)">
        <mask
          id="fm-federated-states-of-micronesia_svg__c"
          width={36}
          height={24}
          x={3}
          y={2}
        ...
        <g mask="url(#fm-federated-states-of-micronesia_svg__c)">
          <path
            fill="#63B3E1"
            fillRule="evenodd"
            d="M3 2v24h36V2H3Z"
          ...
          />
          <mask
            id="fm-federated-states-of-micronesia_svg__d"
            width={36}
            height={24}
            x={3}
            y={2}
          ...
          <g mask="url(#fm-federated-states-of-micronesia_svg__d)">
            <path
              fill="#F7FCFF"
              fillRule="evenodd"
    ...
    <defs>
      <clipPath id="fm-federated-states-of-micronesia_svg__b">
        <rect width={36} height={24} x={3} y={2} fill="#fff" rx={2} />
      </clipPath>
      <filter
        id="fm-federated-states-of-micronesia_svg__a"
        width={42}
        height={30}
        x={0}
        y={0}
...
export default FmFederatedStatesOfMicronesia;
