...
const LyLibya = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g filter="url(#ly-libya_svg__a)">
      <g clipPath="url(#ly-libya_svg__b)">
        <mask
          id="ly-libya_svg__c"
          width={36}
          height={24}
        ...
        <g mask="url(#ly-libya_svg__c)" fillRule="evenodd" clipRule="evenodd">
