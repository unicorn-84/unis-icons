...
const CvCaboVerde = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g filter="url(#cv-cabo-verde_svg__a)">
      <g clipPath="url(#cv-cabo-verde_svg__b)">
        <mask
          id="cv-cabo-verde_svg__c"
          width={36}
          height={24}
          x={3}
          y={2}
        ...
        <g mask="url(#cv-cabo-verde_svg__c)">
          <path
            fill="#4141DB"
            fillRule="evenodd"
            d="M3 2v24h36V2H3Z"
          ...
          <g mask="url(#cv-cabo-verde_svg__d)">
            <path
              fill="#F90000"
              stroke="#F7FCFF"
              strokeWidth={2}
            ...
            />
            <g filter="url(#cv-cabo-verde_svg__e)">
              <path
                fill="#FFDE00"
                fillRule="evenodd"
    ...
    <defs>
      ...
      <clipPath id="cv-cabo-verde_svg__b">
