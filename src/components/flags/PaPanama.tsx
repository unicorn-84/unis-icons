...
const PaPanama = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g filter="url(#pa-panama_svg__a)">
      <g clipPath="url(#pa-panama_svg__b)">
        <mask
          id="pa-panama_svg__c"
          width={36}
          height={24}
