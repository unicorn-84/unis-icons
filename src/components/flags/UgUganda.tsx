...
const UgUganda = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g filter="url(#ug-uganda_svg__a)">
      <g clipPath="url(#ug-uganda_svg__b)">
        <mask
          id="ug-uganda_svg__c"
          width={36}
          height={24}
