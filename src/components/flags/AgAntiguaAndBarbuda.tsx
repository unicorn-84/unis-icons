...
const AgAntiguaAndBarbuda = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g filter="url(#ag-antigua-and-barbuda_svg__a)">
      <g clipPath="url(#ag-antigua-and-barbuda_svg__b)">
        <mask
          id="ag-antigua-and-barbuda_svg__c"
          width={36}
          height={24}
          x={3}
          y={2}
        ...
        <g mask="url(#ag-antigua-and-barbuda_svg__c)">
          <path
            fill="#1B1B1B"
            fillRule="evenodd"
            d="M3 2h36v24H3V2Z"
    ...
    <defs>
      <clipPath id="ag-antigua-and-barbuda_svg__b">
        <rect width={36} height={24} x={3} y={2} fill="#fff" rx={2} />
      </clipPath>
      <filter
        id="ag-antigua-and-barbuda_svg__a"
        width={42}
        height={30}
        x={0}
        y={0}
...
export default AgAntiguaAndBarbuda;
