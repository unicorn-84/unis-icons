...
const LaLaos = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g filter="url(#la-laos_svg__a)">
      <g clipPath="url(#la-laos_svg__b)">
        <mask
          id="la-laos_svg__c"
          width={36}
          height={24}
        ...
        <g mask="url(#la-laos_svg__c)" fillRule="evenodd" clipRule="evenodd">
