...
const WsSamoa = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g filter="url(#ws-samoa_svg__a)">
      <g clipPath="url(#ws-samoa_svg__b)">
        <mask
          id="ws-samoa_svg__c"
          width={36}
          height={24}
        ...
        <g mask="url(#ws-samoa_svg__c)">
          ...
          <g mask="url(#ws-samoa_svg__d)" fillRule="evenodd" clipRule="evenodd">
