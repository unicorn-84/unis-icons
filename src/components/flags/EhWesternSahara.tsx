...
const EhWesternSahara = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g filter="url(#eh-western-sahara_svg__a)">
      <g clipPath="url(#eh-western-sahara_svg__b)">
        <mask
          id="eh-western-sahara_svg__c"
          width={36}
          height={24}
          x={3}
          y={2}
        ...
        <g
          mask="url(#eh-western-sahara_svg__c)"
          fillRule="evenodd"
          clipRule="evenodd"
        >
    ...
    <defs>
      <clipPath id="eh-western-sahara_svg__b">
        <rect width={36} height={24} x={3} y={2} fill="#fff" rx={2} />
      </clipPath>
      <filter
        id="eh-western-sahara_svg__a"
        width={42}
        height={30}
        x={0}
        y={0}
...
export default EhWesternSahara;
