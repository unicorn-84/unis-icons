...
const CnChina = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g filter="url(#cn-china_svg__a)">
      <g clipPath="url(#cn-china_svg__b)">
        <mask
          id="cn-china_svg__c"
          width={36}
          height={24}
        ...
        <g mask="url(#cn-china_svg__c)" fillRule="evenodd" clipRule="evenodd">
