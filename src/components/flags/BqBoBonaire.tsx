...
const BqBoBonaire = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g filter="url(#bq-bo-bonaire_svg__a)">
      <g clipPath="url(#bq-bo-bonaire_svg__b)">
        <mask
          id="bq-bo-bonaire_svg__c"
          width={36}
          height={24}
          x={3}
          y={2}
        ...
        <g mask="url(#bq-bo-bonaire_svg__c)">
          <path
            fill="#fff"
            fillRule="evenodd"
            d="M3 2h36v24H3V2Z"
          ...
          <path
            ...
            clipRule="evenodd"
          />
          <mask id="bq-bo-bonaire_svg__d" fill="#fff">
            <path
              fillRule="evenodd"
    ...
    <defs>
      <clipPath id="bq-bo-bonaire_svg__b">
        <rect width={36} height={24} x={3} y={2} fill="#fff" rx={2} />
      </clipPath>
      <filter
        id="bq-bo-bonaire_svg__a"
        width={42}
        height={30}
        x={0}
        y={0}
