...
const GuGuam = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g filter="url(#gu-guam_svg__a)">
      <g clipPath="url(#gu-guam_svg__b)">
        <mask
          id="gu-guam_svg__c"
          width={36}
          height={24}
