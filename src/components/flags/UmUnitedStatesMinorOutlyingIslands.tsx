...
const UmUnitedStatesMinorOutlyingIslands = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g filter="url(#um-united-states-minor-outlying-islands_svg__a)">
      <g clipPath="url(#um-united-states-minor-outlying-islands_svg__b)">
        <mask
          id="um-united-states-minor-outlying-islands_svg__c"
          width={36}
          height={24}
          x={3}
          y={2}
        ...
        <g mask="url(#um-united-states-minor-outlying-islands_svg__c)">
          <path
            fill="#F7FCFF"
            fillRule="evenodd"
            d="M3 2h36v24H3V2Z"
    ...
    <defs>
      <clipPath id="um-united-states-minor-outlying-islands_svg__b">
        <rect width={36} height={24} x={3} y={2} fill="#fff" rx={2} />
      </clipPath>
      <filter
        id="um-united-states-minor-outlying-islands_svg__a"
        width={42}
        height={30}
        x={0}
        y={0}
...
export default UmUnitedStatesMinorOutlyingIslands;
