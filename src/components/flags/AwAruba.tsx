...
const AwAruba = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g filter="url(#aw-aruba_svg__a)">
      <g clipPath="url(#aw-aruba_svg__b)">
        <mask
          id="aw-aruba_svg__c"
          width={36}
          height={24}
        ...
        <g mask="url(#aw-aruba_svg__c)">
          ...
          <g mask="url(#aw-aruba_svg__d)" fillRule="evenodd" clipRule="evenodd">
            <path
              fill="red"
              stroke="#F7FCFF"
              strokeWidth={0.35}
