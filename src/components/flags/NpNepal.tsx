...
const NpNepal = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g filter="url(#np-nepal_svg__a)">
      <g clipPath="url(#np-nepal_svg__b)">
        ...
        <g mask="url(#np-nepal_svg__c)" fillRule="evenodd" clipRule="evenodd">
          <path
            fill="#F7FCFF"
