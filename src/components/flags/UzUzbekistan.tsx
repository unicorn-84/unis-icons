...
const UzUzbekistan = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g filter="url(#uz-uzbekistan_svg__a)">
      <g clipPath="url(#uz-uzbekistan_svg__b)">
        <mask
          id="uz-uzbekistan_svg__c"
          width={36}
          height={24}
          x={3}
          y={2}
        ...
        <g mask="url(#uz-uzbekistan_svg__c)">
          <path
            fill="#14DC5A"
            fillRule="evenodd"
            d="M3 18h36v8H3v-8Z"
    ...
    <defs>
      <clipPath id="uz-uzbekistan_svg__b">
        <rect width={36} height={24} x={3} y={2} fill="#fff" rx={2} />
      </clipPath>
      <filter
        id="uz-uzbekistan_svg__a"
        width={42}
        height={30}
        x={0}
        y={0}
