...
const NrNauru = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g filter="url(#nr-nauru_svg__a)">
      <g clipPath="url(#nr-nauru_svg__b)">
        <path
          fill="#2E42A5"
          fillRule="evenodd"
          d="M3 2v24h36V2H3Z"
        ...
        <g mask="url(#nr-nauru_svg__c)" fillRule="evenodd" clipRule="evenodd">
