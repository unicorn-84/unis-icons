...
const BrBrazil = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g filter="url(#br-brazil_svg__a)">
      <g clipPath="url(#br-brazil_svg__b)">
        <mask
          id="br-brazil_svg__c"
          width={36}
          height={24}
        ...
        <g mask="url(#br-brazil_svg__c)">
          ...
          <g mask="url(#br-brazil_svg__d)">
            <g
              filter="url(#br-brazil_svg__e)"
              fillRule="evenodd"
              clipRule="evenodd"
            >
              <path
