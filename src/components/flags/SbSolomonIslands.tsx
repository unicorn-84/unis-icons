...
const SbSolomonIslands = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g filter="url(#sb-solomon-islands_svg__a)">
      <g clipPath="url(#sb-solomon-islands_svg__b)">
        <mask
          id="sb-solomon-islands_svg__c"
          width={36}
          height={24}
          x={3}
          y={2}
        ...
        <g mask="url(#sb-solomon-islands_svg__c)">
          <path
            fill="#3D58DB"
            fillRule="evenodd"
            d="M3 2v24h36V2H3Z"
          ...
          <g mask="url(#sb-solomon-islands_svg__d)">
            <path
              fill="#579D20"
              fillRule="evenodd"
              d="M3 26h36V2L3 26Z"
    ...
    <defs>
      <clipPath id="sb-solomon-islands_svg__b">
        <rect width={36} height={24} x={3} y={2} fill="#fff" rx={2} />
      </clipPath>
      <filter
        id="sb-solomon-islands_svg__a"
        width={42}
        height={30}
        x={0}
        y={0}
...
export default SbSolomonIslands;
