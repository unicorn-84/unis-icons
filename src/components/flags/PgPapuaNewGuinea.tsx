...
const PgPapuaNewGuinea = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g filter="url(#pg-papua-new-guinea_svg__a)">
      <g clipPath="url(#pg-papua-new-guinea_svg__b)">
        <mask
          id="pg-papua-new-guinea_svg__c"
          width={36}
          height={24}
          x={3}
          y={2}
        ...
        <g mask="url(#pg-papua-new-guinea_svg__c)">
    ...
    <defs>
      <clipPath id="pg-papua-new-guinea_svg__b">
        <rect width={36} height={24} x={3} y={2} fill="#fff" rx={2} />
      </clipPath>
      <filter
        id="pg-papua-new-guinea_svg__a"
        width={42}
        height={30}
        x={0}
        y={0}
...
export default PgPapuaNewGuinea;
