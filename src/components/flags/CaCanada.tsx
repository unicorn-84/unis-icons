...
const CaCanada = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g filter="url(#ca-canada_svg__a)">
      <g clipPath="url(#ca-canada_svg__b)">
        <mask
          id="ca-canada_svg__c"
          width={36}
          height={24}
        ...
        <g mask="url(#ca-canada_svg__c)" fillRule="evenodd" clipRule="evenodd">
