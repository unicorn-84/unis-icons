...
const ToTonga = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g filter="url(#to-tonga_svg__a)">
      <g clipPath="url(#to-tonga_svg__b)">
        <mask
          id="to-tonga_svg__c"
          width={36}
          height={24}
