...
const NeNiger = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g filter="url(#ne-niger_svg__a)">
      <g clipPath="url(#ne-niger_svg__b)">
        <mask
          id="ne-niger_svg__c"
          width={36}
          height={24}
        ...
        <g mask="url(#ne-niger_svg__c)">
          ...
          <g mask="url(#ne-niger_svg__d)" fillRule="evenodd" clipRule="evenodd">
