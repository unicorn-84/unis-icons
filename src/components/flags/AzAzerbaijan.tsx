...
const AzAzerbaijan = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g filter="url(#az-azerbaijan_svg__a)">
      <g clipPath="url(#az-azerbaijan_svg__b)">
        <mask
          id="az-azerbaijan_svg__c"
          width={36}
          height={24}
          x={3}
          y={2}
        ...
        <g mask="url(#az-azerbaijan_svg__c)">
          <path
            fill="#AF0100"
            fillRule="evenodd"
            d="M3 2v24h36V2H3Z"
    ...
    <defs>
      <clipPath id="az-azerbaijan_svg__b">
        <rect width={36} height={24} x={3} y={2} fill="#fff" rx={2} />
      </clipPath>
      <filter
        id="az-azerbaijan_svg__a"
        width={42}
        height={30}
        x={0}
        y={0}
