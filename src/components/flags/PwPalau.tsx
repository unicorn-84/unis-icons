...
const PwPalau = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g filter="url(#pw-palau_svg__a)">
      <g clipPath="url(#pw-palau_svg__b)">
        <mask
          id="pw-palau_svg__c"
          width={36}
          height={24}
