...
const SgSingapore = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g filter="url(#sg-singapore_svg__a)">
      <g clipPath="url(#sg-singapore_svg__b)">
        <mask
          id="sg-singapore_svg__c"
          width={36}
          height={24}
          x={3}
          y={2}
        ...
        <g mask="url(#sg-singapore_svg__c)">
          <path
            fill="#F7FCFF"
            fillRule="evenodd"
            d="M3 2v24h36V2H3Z"
    ...
    <defs>
      <clipPath id="sg-singapore_svg__b">
        <rect width={36} height={24} x={3} y={2} fill="#fff" rx={2} />
      </clipPath>
      <filter
        id="sg-singapore_svg__a"
        width={42}
        height={30}
        x={0}
        y={0}
