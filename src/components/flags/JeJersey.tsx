...
const JeJersey = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g filter="url(#je-jersey_svg__a)">
      <g clipPath="url(#je-jersey_svg__b)">
        <mask
          id="je-jersey_svg__c"
          width={36}
          height={24}
