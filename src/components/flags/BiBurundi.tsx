...
const BiBurundi = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g filter="url(#bi-burundi_svg__a)">
      <g clipPath="url(#bi-burundi_svg__b)">
        <mask
          id="bi-burundi_svg__c"
          width={36}
          height={24}
          x={3}
          y={2}
        ...
        <g mask="url(#bi-burundi_svg__c)">
          <rect width={36} height={24} x={3} y={2} fill="#5EAA22" rx={2} />
          <mask
            id="bi-burundi_svg__d"
            width={54}
            height={30}
            x={-6}
            y={-1}
    ...
    <defs>
      <clipPath id="bi-burundi_svg__b">
        <rect width={36} height={24} x={3} y={2} fill="#fff" rx={2} />
      </clipPath>
      <filter
        id="bi-burundi_svg__a"
        width={42}
        height={30}
        x={0}
        y={0}
