...
const GfFrenchGuiana = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g filter="url(#gf-french-guiana_svg__a)">
      <g clipPath="url(#gf-french-guiana_svg__b)">
        <mask
          id="gf-french-guiana_svg__c"
          width={36}
          height={24}
          x={3}
          y={2}
        ...
        <g mask="url(#gf-french-guiana_svg__c)">
    ...
    <defs>
      <clipPath id="gf-french-guiana_svg__b">
        <rect width={36} height={24} x={3} y={2} fill="#fff" rx={2} />
      </clipPath>
      <filter
        id="gf-french-guiana_svg__a"
        width={42}
        height={30}
        x={0}
        y={0}
