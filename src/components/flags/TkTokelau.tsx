...
const TkTokelau = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g filter="url(#tk-tokelau_svg__a)">
      <g clipPath="url(#tk-tokelau_svg__b)">
        <mask
          id="tk-tokelau_svg__c"
          width={36}
          height={24}
          x={3}
          y={2}
    ...
    <defs>
      <clipPath id="tk-tokelau_svg__b">
        <rect width={36} height={24} x={3} y={2} fill="#fff" rx={2} />
      </clipPath>
      <filter
        id="tk-tokelau_svg__a"
        width={42}
        height={30}
        x={0}
        y={0}
