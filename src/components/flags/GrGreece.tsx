...
const GrGreece = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g filter="url(#gr-greece_svg__a)">
      <g clipPath="url(#gr-greece_svg__b)">
        <mask
          id="gr-greece_svg__c"
          width={36}
          height={24}
