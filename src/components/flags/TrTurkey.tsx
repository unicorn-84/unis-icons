...
const TrTurkey = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g filter="url(#tr-turkey_svg__a)">
      <g clipPath="url(#tr-turkey_svg__b)">
        <mask
          id="tr-turkey_svg__c"
          width={36}
          height={24}
