...
const DzAlgeria = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g filter="url(#dz-algeria_svg__a)">
      <g
        clipPath="url(#dz-algeria_svg__b)"
        fillRule="evenodd"
        clipRule="evenodd"
      >
    ...
    <defs>
      <clipPath id="dz-algeria_svg__b">
        <rect width={36} height={24} x={3} y={2} fill="#fff" rx={2} />
      </clipPath>
      <filter
        id="dz-algeria_svg__a"
        width={42}
        height={30}
        x={0}
        y={0}
