...
const EgEgypt = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g filter="url(#eg-egypt_svg__a)">
      <g clipPath="url(#eg-egypt_svg__b)">
        <mask
          id="eg-egypt_svg__c"
          width={36}
          height={24}
