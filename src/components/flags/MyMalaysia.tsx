...
const MyMalaysia = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g filter="url(#my-malaysia_svg__a)">
      <g clipPath="url(#my-malaysia_svg__b)">
        <mask
          id="my-malaysia_svg__c"
          width={36}
          height={24}
          x={3}
          y={2}
    ...
    <defs>
      <clipPath id="my-malaysia_svg__b">
        <rect width={36} height={24} x={3} y={2} fill="#fff" rx={2} />
      </clipPath>
      <filter
        id="my-malaysia_svg__a"
        width={42}
        height={30}
        x={0}
        y={0}
