...
const IlIsreal = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g filter="url(#il-isreal_svg__a)">
      <g clipPath="url(#il-isreal_svg__b)">
        <mask
          id="il-isreal_svg__c"
          width={36}
          height={24}
