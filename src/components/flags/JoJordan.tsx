...
const JoJordan = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g filter="url(#jo-jordan_svg__a)">
      <g clipPath="url(#jo-jordan_svg__b)">
        <mask
          id="jo-jordan_svg__c"
          width={36}
          height={24}
