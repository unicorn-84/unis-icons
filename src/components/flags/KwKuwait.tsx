...
const KwKuwait = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g filter="url(#kw-kuwait_svg__a)">
      <g clipPath="url(#kw-kuwait_svg__b)">
        <mask
          id="kw-kuwait_svg__c"
          width={36}
          height={24}
