...
const QaQatar = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g filter="url(#qa-qatar_svg__a)">
      <g clipPath="url(#qa-qatar_svg__b)">
        <mask
          id="qa-qatar_svg__c"
          width={36}
          height={24}
