...
const VeVenezuela = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g filter="url(#ve-venezuela_svg__a)">
      <g clipPath="url(#ve-venezuela_svg__b)">
        <mask
          id="ve-venezuela_svg__c"
          width={36}
          height={24}
          x={3}
          y={2}
        ...
        <g mask="url(#ve-venezuela_svg__c)">
          <path
            fill="#2E42A5"
            fillRule="evenodd"
            d="M3 2v24h36V2H3Z"
    ...
    <defs>
      <clipPath id="ve-venezuela_svg__b">
        <rect width={36} height={24} x={3} y={2} fill="#fff" rx={2} />
      </clipPath>
      <filter
        id="ve-venezuela_svg__a"
        width={42}
        height={30}
        x={0}
        y={0}
