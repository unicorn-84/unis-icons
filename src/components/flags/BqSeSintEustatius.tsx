...
const BqSeSintEustatius = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g filter="url(#bq-se-sint-eustatius_svg__a)">
      <g clipPath="url(#bq-se-sint-eustatius_svg__b)">
        <mask
          id="bq-se-sint-eustatius_svg__c"
          width={36}
          height={24}
          x={3}
          y={2}
        ...
        <g mask="url(#bq-se-sint-eustatius_svg__c)">
          <path
            fill="#00268D"
            fillRule="evenodd"
            d="M3 2h36v24H3V2Z"
          ...
          />
          <mask
            id="bq-se-sint-eustatius_svg__d"
            width={34}
            height={16}
            x={4}
            y={6}
          ...
          <g mask="url(#bq-se-sint-eustatius_svg__d)">
            <path
              fill="#059334"
    ...
    <defs>
      <clipPath id="bq-se-sint-eustatius_svg__b">
        <rect width={36} height={24} x={3} y={2} fill="#fff" rx={2} />
      </clipPath>
      <filter
        id="bq-se-sint-eustatius_svg__a"
        width={42}
        height={30}
        x={0}
        y={0}
...
export default BqSeSintEustatius;
