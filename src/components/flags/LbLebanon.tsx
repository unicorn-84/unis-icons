...
const LbLebanon = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g filter="url(#lb-lebanon_svg__a)">
      <g clipPath="url(#lb-lebanon_svg__b)">
        <mask
          id="lb-lebanon_svg__c"
          width={36}
          height={24}
          x={3}
          y={2}
        ...
        <g mask="url(#lb-lebanon_svg__c)" fillRule="evenodd" clipRule="evenodd">
    ...
    <defs>
      <clipPath id="lb-lebanon_svg__b">
        <rect width={36} height={24} x={3} y={2} fill="#fff" rx={2} />
      </clipPath>
      <filter
        id="lb-lebanon_svg__a"
        width={42}
        height={30}
        x={0}
        y={0}
