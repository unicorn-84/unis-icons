...
const KpKoreaNorth = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g filter="url(#kp-korea-north_svg__a)">
      <g clipPath="url(#kp-korea-north_svg__b)">
        <mask
          id="kp-korea-north_svg__c"
          width={36}
          height={24}
          x={3}
          y={2}
        ...
        <g mask="url(#kp-korea-north_svg__c)">
          <path
            fill="#3D58DB"
            fillRule="evenodd"
            d="M3 2v24h36V2H3Z"
          ...
          <g mask="url(#kp-korea-north_svg__d)">
            <path
              fill="#C51918"
              stroke="#F7FCFF"
              strokeWidth={2}
    ...
    <defs>
      <clipPath id="kp-korea-north_svg__b">
        <rect width={36} height={24} x={3} y={2} fill="#fff" rx={2} />
      </clipPath>
      <filter
        id="kp-korea-north_svg__a"
        width={42}
        height={30}
        x={0}
        y={0}
