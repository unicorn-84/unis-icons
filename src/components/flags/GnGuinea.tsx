...
const GnGuinea = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g filter="url(#gn-guinea_svg__a)">
      <g clipPath="url(#gn-guinea_svg__b)">
        <mask
          id="gn-guinea_svg__c"
          width={36}
          height={24}
        ...
        <g mask="url(#gn-guinea_svg__c)" fillRule="evenodd" clipRule="evenodd">
