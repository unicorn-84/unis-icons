...
const GdGrenada = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g filter="url(#gd-grenada_svg__a)">
      <g clipPath="url(#gd-grenada_svg__b)">
        <mask
          id="gd-grenada_svg__c"
          width={36}
          height={24}
          x={3}
          y={2}
    ...
    <defs>
      <clipPath id="gd-grenada_svg__b">
        <rect width={36} height={24} x={3} y={2} fill="#fff" rx={2} />
      </clipPath>
      <filter
        id="gd-grenada_svg__a"
        width={42}
        height={30}
        x={0}
        y={0}
