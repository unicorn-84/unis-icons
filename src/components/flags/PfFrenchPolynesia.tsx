...
const PfFrenchPolynesia = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g filter="url(#pf-french-polynesia_svg__a)">
      <g clipPath="url(#pf-french-polynesia_svg__b)">
        <mask
          id="pf-french-polynesia_svg__c"
          width={36}
          height={24}
          x={3}
          y={2}
        ...
        <g mask="url(#pf-french-polynesia_svg__c)">
          <path
            fill="#F7FCFF"
            fillRule="evenodd"
            d="M3 2v24h36V2H3Z"
          ...
          <g mask="url(#pf-french-polynesia_svg__d)">
            <path
              fill="#BF2714"
              fillRule="evenodd"
            ...
            <g mask="url(#pf-french-polynesia_svg__e)">
              <path
                fill="#5277B9"
                fillRule="evenodd"
    ...
    <defs>
      <clipPath id="pf-french-polynesia_svg__b">
        <rect width={36} height={24} x={3} y={2} fill="#fff" rx={2} />
      </clipPath>
      <filter
        id="pf-french-polynesia_svg__a"
        width={42}
        height={30}
        x={0}
        y={0}
...
export default PfFrenchPolynesia;
