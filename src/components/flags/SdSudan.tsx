...
const SdSudan = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g filter="url(#sd-sudan_svg__a)">
      <g clipPath="url(#sd-sudan_svg__b)">
        <mask
          id="sd-sudan_svg__c"
          width={36}
          height={24}
        ...
        <g mask="url(#sd-sudan_svg__c)" fillRule="evenodd" clipRule="evenodd">
