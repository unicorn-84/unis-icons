...
const CuCuba = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g filter="url(#cu-cuba_svg__a)">
      <g clipPath="url(#cu-cuba_svg__b)">
        <mask
          id="cu-cuba_svg__c"
          width={36}
          height={24}
