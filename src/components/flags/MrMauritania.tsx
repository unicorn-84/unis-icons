...
const MrMauritania = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g filter="url(#mr-mauritania_svg__a)">
      <g clipPath="url(#mr-mauritania_svg__b)">
        <mask
          id="mr-mauritania_svg__c"
          width={36}
          height={24}
          x={3}
          y={2}
        ...
        <g mask="url(#mr-mauritania_svg__c)">
          <path
            fill="#1C7B4D"
            fillRule="evenodd"
            d="M3 2v24h36V2H3Z"
    ...
    <defs>
      <clipPath id="mr-mauritania_svg__b">
        <rect width={36} height={24} x={3} y={2} fill="#fff" rx={2} />
      </clipPath>
      <filter
        id="mr-mauritania_svg__a"
        width={42}
        height={30}
        x={0}
        y={0}
