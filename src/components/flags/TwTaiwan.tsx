...
const TwTaiwan = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g filter="url(#tw-taiwan_svg__a)">
      <g clipPath="url(#tw-taiwan_svg__b)">
        <mask
          id="tw-taiwan_svg__c"
          width={36}
          height={24}
