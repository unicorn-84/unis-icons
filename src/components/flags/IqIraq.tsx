...
const IqIraq = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g filter="url(#iq-iraq_svg__a)">
      <g clipPath="url(#iq-iraq_svg__b)">
        <mask
          id="iq-iraq_svg__c"
          width={36}
          height={24}
        ...
        <g mask="url(#iq-iraq_svg__c)">
          ...
          <g mask="url(#iq-iraq_svg__d)" fillRule="evenodd" clipRule="evenodd">
