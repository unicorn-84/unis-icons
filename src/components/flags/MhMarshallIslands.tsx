...
const MhMarshallIslands = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g filter="url(#mh-marshall-islands_svg__a)">
      <g clipPath="url(#mh-marshall-islands_svg__b)">
        <mask
          id="mh-marshall-islands_svg__c"
          width={36}
          height={24}
          x={3}
          y={2}
        ...
        <g mask="url(#mh-marshall-islands_svg__c)">
          <path
            fill="#3D58DB"
            fillRule="evenodd"
            d="M3 2v24h36V2H3Z"
          ...
          <g mask="url(#mh-marshall-islands_svg__d)">
            <path
              fill="#F7FCFF"
              fillRule="evenodd"
    ...
    <defs>
      <clipPath id="mh-marshall-islands_svg__b">
        <rect width={36} height={24} x={3} y={2} fill="#fff" rx={2} />
      </clipPath>
      <filter
        id="mh-marshall-islands_svg__a"
        width={42}
        height={30}
        x={0}
        y={0}
...
export default MhMarshallIslands;
